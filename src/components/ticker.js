  ...
  render() {
    ...
    return (
      <div>
        ...
        <button onClick={() => {this.setState({ testHtml: [...this.state.testHtml, 4] })}}>add tweet</button>
      </div>
    )
